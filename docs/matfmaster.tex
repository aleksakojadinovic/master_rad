...
\autor{Алекса Којадиновић}
% Naslov teze na srpskom jeziku (u odabranom pismu)
\naslov{Архитектура и дизајн веб платформе за управљање корисничким жалбама и захтевимa}
% Godina u kojoj je teza predana komisiji
\godina{2023}
% Ime i afilijacija mentora (u odabranom pismu)
\mentor{Владимир Филиповић}
% Ime i afilijacija prvog člana komisije (u odabranom pismu)
\komisijaA{Саша Малков}
% Ime i afilijacija drugog člana komisije (u odabranom pismu)
\komisijaB{Александар Картељ}
% Ime i afilijacija trećeg člana komisije (opciono)
% \komisijaC{}
% Ime i afilijacija četvrtog člana komisije (opciono)
% \komisijaD{}
% Datum odbrane (obrisati ili iskomentarisati narednu liniju ako datum odbrane nije poznat)
\datumodbrane{xx. јануар xxxx.}
